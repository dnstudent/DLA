...
class mLSTMCell(Layer):
    ...
    # Arguments
        ...
        forward_units : Positive integer, dimensionality of the dense layers hidden state output space
    ...
    def build(self, input_shape):
        ...
        self.kernel_hidden1=self.add_weight(shape=(self.input_units,self.forward_units),
                                            name='hidden1_kernel',
                                            initializer=self.kernel_initializer,
                                            regularizer=self.kernel_regularizer,
                                            constraint=self.kernel_constraint)
        ...
        self.kernel_hidden2=self.add_weight(shape=(self.forward_units, self.forward_units),
                                            name='hidden2_kernel',
                                            initializer=self.kernel_initializer,
                                            regularizer=self.kernel_regularizer,
                                            constraint=self.kernel_constraint)
        ...
        #rectifier Kernel
        self.kernel_r=self.add_weight(shape=(self.forward_units, self.output_units),
        ...
        bias_initializer = self.bias_initializer
        #hidden layer 1 bias
        self.bias_hidden1=self.add_weight(shape=(self.forward_units,),
                                          name='hidden1_bias',
                                          initializer=bias_initializer,
                                          regularizer=self.bias_regularizer,
                                          constraint=self.bias_constraint)
        #hidden layer 2 bias
        self.bias_hidden2=self.add_weight(shape=(self.forward_units,),
                                          name='hidden2_bias',
                                          initializer=bias_initializer,
                                          regularizer=self.bias_regularizer,
                                          constraint=self.bias_constraint)
...
#        print(c_tm1.shape)
        ...
        if self.implementation == 1:
            ...
            # Sembra sbagliata. Manca l'utilizzo della variabile intermedia
            if 0. < self.dropout < 1.:
                inputs *= dp_mask[0]
    ...
    def get_config(self):
        config = {'input_units': self.input_units,
                  'hidden_units': self.forward_units,
...
class mLSTM(RNN):
    ...
    def hidden_units(self):
        return self.cell.forward_units
