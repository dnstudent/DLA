...
class MonotonicLSTM(nn.Module):
    def __init__(self, input_size: int, hidden_size: int, forward_size: int, dropout_rate: float, batch_first: bool = True):
        assert batch_first, "Only batch first is supported"
        super().__init__()
