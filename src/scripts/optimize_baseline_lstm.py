...
def add_program_arguments(parser):
    parser.add_argument(
        "--study_name",
        action="store",
        default="baseline_lstm_optimization",
        type=str,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Baseline LSTM optimization")
    ...
    study.optimize(
        objective(args.accelerator, args.max_epochs, args.patience, args.csv_path, workdir, args.n_devices, args.profile),
